...
//		Read data from xml file
		Document file = DocumentBuilderFactory.newInstance().newDocumentBuilder().parse(new File(
				"F:\\Seleniumm training\\SeleniumUiFrameworkOrangeHRM\\src\\main\\resources\\DemoObjectRepository\\LoginPage.xml"));
...
//		Splitting the Locator and value
		...
		String passwordLoc = password.split(":")[1];
...
//		password
		if (passLoc.equals("name")) {
			driver.findElement(By.name(passwordLoc)).sendKeys("admin123");
		}

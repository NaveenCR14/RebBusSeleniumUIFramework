...
public class Pages {
	...
	public food_order_page fp;
    public restaurant_menu_page rmp;
    public popularfood_restaurant_serving_page pp;
    public train_restaurants_page tp;
	...
	public static void loadAllPages(WebDriver driver) {
		...
		Pages p = new Pages();
		p.fp=PageFactory.initElements(driver, food_order_page.class);
        p.rmp=PageFactory.initElements(driver, restaurant_menu_page.class);
        p.pp=PageFactory.initElements(driver, popularfood_restaurant_serving_page.class);
        p.tp=PageFactory.initElements(driver, train_restaurants_page.class);

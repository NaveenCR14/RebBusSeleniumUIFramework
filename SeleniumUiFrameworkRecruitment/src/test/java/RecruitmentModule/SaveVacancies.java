...
//		driver.manage().window().maximize();
	...
	public void performAction() {
		...
		driver.findElement(By.xpath("//label[text()=\"Vacancy Name\"]/../..//input")).sendKeys("SDE");
		...
		driver.findElement(By.xpath("//label[text()=\"Hiring Manager\"]/../..//input")).sendKeys("a");
		...
		driver.findElement(By.xpath("//label[text()=\"Hiring Manager\"]/../..//input")).sendKeys(Keys.ARROW_DOWN,
				Keys.ENTER);

		driver.findElement(By.xpath("//label[text()=\"Number of Positions\"]/../..//input")).sendKeys("3");

...
//		driver.findElement(By.xpath("//input[@placeholder=\"yyyy-dd-mm\"]")).sendKeys("2026-01-11");
	...
	public void verify() {
		...
		driver.findElement(By.xpath("//label[text()='Candidate Name']/../..//input")).sendKeys("Spider");
		...
		driver.findElement(By.xpath("//label[text()='Candidate Name']/../..//input")).sendKeys(Keys.ARROW_DOWN,
				Keys.ENTER);

		driver.findElement(By.xpath("//button[contains(., 'Search')]")).click();

		WebElement result = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"//div[@class=\"oxd-table-row oxd-table-row--with-border\"]//div[contains(., 'Spiderman Spider S')]")));
